...
export const INITIAL_PROJECTS = [
  // ──────────────────────────────────────────────────
  // PROJETO 1 — Casamento Fulana & Beltrano (Aguardando Aprovação / Risco SLA 48h)
  // Horas pendentes: Convite (10h) + Retro (8h) + Festa (20h) = 38h
  // ──────────────────────────────────────────────────
  {
    id: 'proj-1',
    name: 'Casamento Fulana & Beltrano',
    client: 'Fulana de Tal',
  ...
  // ──────────────────────────────────────────────────
  // PROJETO 2 — 15 Anos Ana Sicrana (Em Criação / Risco Assets SLA 72h)
  // Horas pendentes: Std (5h) + Convite (10h) + Retro (8h) + Festa (20h) = 43h
  // ──────────────────────────────────────────────────
  {
    id: 'proj-2',
    name: '15 Anos Ana Sicrana',
    client: 'Joana Sicrana (Mãe)',
    stage: 'creation',
    value: 4200,
  ...
  // ──────────────────────────────────────────────────
  // PROJETO 3 — Bodas de Ouro Família Beltrano (Em Criação)
  // Horas pendentes: Std (5h) + Convite (10h) + Festa (20h) = 35h
  // ──────────────────────────────────────────────────
  {
    id: 'proj-3',
    name: 'Bodas de Ouro Família Beltrano',
    client: 'José Beltrano',
    stage: 'creation',
    value: 3500,
  ...
  // ──────────────────────────────────────────────────
  // PROJETO 4 — Casamento João & Pedro (Ajustes & Gráfica)
  // Horas pendentes: Papelaria Festa (20h) = 20h
  // ──────────────────────────────────────────────────
  {
    id: 'proj-4',
    name: 'Casamento João & Pedro',
    client: 'João Ninguém',
    stage: 'revisions',
    value: 6200,
  ...
  // ──────────────────────────────────────────────────
  // PROJETO 5 — Casamento Sicrana & Beltrano (Briefing / Recém-contratado)
  // Horas pendentes: Std (5h) + Convite (10h) = 15h
  // ──────────────────────────────────────────────────
  {
    id: 'proj-5',
    name: 'Casamento Sicrana & Beltrano',
    client: 'Sicrana de Tal',
    stage: 'briefing',
    value: 5200,
