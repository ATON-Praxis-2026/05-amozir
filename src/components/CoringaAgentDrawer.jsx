            ...
            <div className="bg-surface-2 border border-line rounded-sm p-4 flex flex-wrap items-center justify-between gap-3">
              <div className="flex items-center gap-3 min-w-0">
                <button
                  ...
                  aria-label={isPlayingAudio ? 'Pausar o Daily Briefing da Maria' : 'Ouvir o Daily Briefing da Maria'}
                ...
                <div className="min-w-0">
                  <h5 className="text-label font-semibold text-ink">Daily Briefing da Maria</h5>
                  <p className="text-caption text-ink-muted">
