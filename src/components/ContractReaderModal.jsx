...
const SAMPLE_CONTRACTS = [
  {
    ...
    fileName: 'Contrato_Urgente_Casamento_Fulana_e_Ciclano_2026.pdf',
    extracted: {
      name: 'Casamento Fulana & Ciclano (Urgente)',
      client: 'Fulana Ciclana',
      category: 'Casamento',
      value: 8400,
  ...
  },
  {
    ...
    fileName: 'Contrato_Casamento_Joana_e_Jose_2027.pdf',
    extracted: {
      name: 'Casamento Joana & José',
      client: 'Joana Exemplo',
      category: 'Casamento',
      value: 9200,
      contractDate: '2026-09-01',
  ...
  },
  {
    ...
    fileName: 'Briefing_15Anos_Luiza_Modelo.docx',
    extracted: {
      name: '15 Anos Luiza Modelo',
      client: 'Rosa Modelo (Mãe)',
      category: '15 Anos',
      value: 6500,
      contractDate: '2026-09-01',
